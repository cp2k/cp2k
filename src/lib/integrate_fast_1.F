    ...
    DO kg=kgmin,0
       ...
       DO jg=jgmin,0
          ...
          END DO
             ...
             coef_xy(1,4)=coef_xy(1,4)+coef_x(1,0)*pol_y(1,1,jg)
             coef_xy(2,4)=coef_xy(2,4)+coef_x(2,0)*pol_y(1,1,jg)
             coef_xy(1,4)=coef_xy(1,4)+coef_x(3,0)*pol_y(2,1,jg)
             coef_xy(2,4)=coef_xy(2,4)+coef_x(4,0)*pol_y(2,1,jg)
             coef_xy(1,5)=coef_xy(1,5)+coef_x(1,1)*pol_y(1,1,jg)
             coef_xy(2,5)=coef_xy(2,5)+coef_x(2,1)*pol_y(1,1,jg)
             coef_xy(1,5)=coef_xy(1,5)+coef_x(3,1)*pol_y(2,1,jg)
             coef_xy(2,5)=coef_xy(2,5)+coef_x(4,1)*pol_y(2,1,jg)
             coef_xy(1,6)=coef_xy(1,6)+coef_x(1,0)*pol_y(1,2,jg)
             coef_xy(2,6)=coef_xy(2,6)+coef_x(2,0)*pol_y(1,2,jg)
             coef_xy(1,6)=coef_xy(1,6)+coef_x(3,0)*pol_y(2,2,jg)
             coef_xy(2,6)=coef_xy(2,6)+coef_x(4,0)*pol_y(2,2,jg)
       END DO
                coef_xyz(1)=coef_xyz(1)+coef_xy(1,1)*pol_z(1,0,kg)
                coef_xyz(1)=coef_xyz(1)+coef_xy(2,1)*pol_z(2,0,kg)
                coef_xyz(2)=coef_xyz(2)+coef_xy(1,2)*pol_z(1,0,kg)
    ...
    DO kg=kgmin,0
       ...
       DO jg=jgmin,0
          ...
          END DO
             ...
             coef_xy(1,5)=coef_xy(1,5)+coef_x(1,0)*pol_y(1,1,jg)
             coef_xy(2,5)=coef_xy(2,5)+coef_x(2,0)*pol_y(1,1,jg)
             coef_xy(1,5)=coef_xy(1,5)+coef_x(3,0)*pol_y(2,1,jg)
             coef_xy(2,5)=coef_xy(2,5)+coef_x(4,0)*pol_y(2,1,jg)
             coef_xy(1,6)=coef_xy(1,6)+coef_x(1,1)*pol_y(1,1,jg)
             coef_xy(2,6)=coef_xy(2,6)+coef_x(2,1)*pol_y(1,1,jg)
             coef_xy(1,6)=coef_xy(1,6)+coef_x(3,1)*pol_y(2,1,jg)
             coef_xy(2,6)=coef_xy(2,6)+coef_x(4,1)*pol_y(2,1,jg)
             coef_xy(1,7)=coef_xy(1,7)+coef_x(1,2)*pol_y(1,1,jg)
             coef_xy(2,7)=coef_xy(2,7)+coef_x(2,2)*pol_y(1,1,jg)
             coef_xy(1,7)=coef_xy(1,7)+coef_x(3,2)*pol_y(2,1,jg)
             coef_xy(2,7)=coef_xy(2,7)+coef_x(4,2)*pol_y(2,1,jg)
             coef_xy(1,8)=coef_xy(1,8)+coef_x(1,0)*pol_y(1,2,jg)
             coef_xy(2,8)=coef_xy(2,8)+coef_x(2,0)*pol_y(1,2,jg)
             coef_xy(1,8)=coef_xy(1,8)+coef_x(3,0)*pol_y(2,2,jg)
             coef_xy(2,8)=coef_xy(2,8)+coef_x(4,0)*pol_y(2,2,jg)
             coef_xy(1,9)=coef_xy(1,9)+coef_x(1,1)*pol_y(1,2,jg)
             coef_xy(2,9)=coef_xy(2,9)+coef_x(2,1)*pol_y(1,2,jg)
             coef_xy(1,9)=coef_xy(1,9)+coef_x(3,1)*pol_y(2,2,jg)
             coef_xy(2,9)=coef_xy(2,9)+coef_x(4,1)*pol_y(2,2,jg)
             coef_xy(1,10)=coef_xy(1,10)+coef_x(1,0)*pol_y(1,3,jg)
             coef_xy(2,10)=coef_xy(2,10)+coef_x(2,0)*pol_y(1,3,jg)
             coef_xy(1,10)=coef_xy(1,10)+coef_x(3,0)*pol_y(2,3,jg)
             coef_xy(2,10)=coef_xy(2,10)+coef_x(4,0)*pol_y(2,3,jg)
       END DO
                coef_xyz(1)=coef_xyz(1)+coef_xy(1,1)*pol_z(1,0,kg)
                coef_xyz(1)=coef_xyz(1)+coef_xy(2,1)*pol_z(2,0,kg)
                coef_xyz(2)=coef_xyz(2)+coef_xy(1,2)*pol_z(1,0,kg)
       ...
       DO jg=jgmin,0
          ...
          DO ig=igmin,igmax
             ...
             s04=grid(i,j2,k2)
                ...
                coef_x(3,6)=coef_x(3,6)+s03*pol_x(6,ig)
                coef_x(4,6)=coef_x(4,6)+s04*pol_x(6,ig)
                coef_x(1,7)=coef_x(1,7)+s01*pol_x(7,ig)
                coef_x(2,7)=coef_x(2,7)+s02*pol_x(7,ig)
                coef_x(3,7)=coef_x(3,7)+s03*pol_x(7,ig)
                coef_x(4,7)=coef_x(4,7)+s04*pol_x(7,ig)
          END DO
             coef_xy(1,1)=coef_xy(1,1)+coef_x(1,0)*pol_y(1,0,jg)
             coef_xy(2,1)=coef_xy(2,1)+coef_x(2,0)*pol_y(1,0,jg)
             coef_xy(1,1)=coef_xy(1,1)+coef_x(3,0)*pol_y(2,0,jg)
       ...
       DO jg=jgmin,0
          ...
          DO ig=igmin,igmax
             ...
             s04=grid(i,j2,k2)
                ...
                coef_x(3,7)=coef_x(3,7)+s03*pol_x(7,ig)
                coef_x(4,7)=coef_x(4,7)+s04*pol_x(7,ig)
                coef_x(1,8)=coef_x(1,8)+s01*pol_x(8,ig)
                coef_x(2,8)=coef_x(2,8)+s02*pol_x(8,ig)
                coef_x(3,8)=coef_x(3,8)+s03*pol_x(8,ig)
                coef_x(4,8)=coef_x(4,8)+s04*pol_x(8,ig)
          END DO
             coef_xy(1,1)=coef_xy(1,1)+coef_x(1,0)*pol_y(1,0,jg)
             coef_xy(2,1)=coef_xy(2,1)+coef_x(2,0)*pol_y(1,0,jg)
             coef_xy(1,1)=coef_xy(1,1)+coef_x(3,0)*pol_y(2,0,jg)
       ...
       DO jg=jgmin,0
          ...
          DO ig=igmin,igmax
             ...
             s04=grid(i,j2,k2)
                ...
                coef_x(3,8)=coef_x(3,8)+s03*pol_x(8,ig)
                coef_x(4,8)=coef_x(4,8)+s04*pol_x(8,ig)
                coef_x(1,9)=coef_x(1,9)+s01*pol_x(9,ig)
                coef_x(2,9)=coef_x(2,9)+s02*pol_x(9,ig)
                coef_x(3,9)=coef_x(3,9)+s03*pol_x(9,ig)
                coef_x(4,9)=coef_x(4,9)+s04*pol_x(9,ig)
          END DO
             coef_xy(1,1)=coef_xy(1,1)+coef_x(1,0)*pol_y(1,0,jg)
             coef_xy(2,1)=coef_xy(2,1)+coef_x(2,0)*pol_y(1,0,jg)
             coef_xy(1,1)=coef_xy(1,1)+coef_x(3,0)*pol_y(2,0,jg)
