...
#else
    CALL mp_abort("acc_hostmem_alloc_c: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_c_2D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_c_3D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_c_4D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_dealloc_c: ACC not compiled in.")
#endif
