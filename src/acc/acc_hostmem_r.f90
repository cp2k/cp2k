...
#else
    CALL mp_abort("acc_hostmem_alloc_r: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_r_2D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_r_3D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_alloc_r_4D: ACC not compiled in.")
#endif
...
#else
    CALL mp_abort("acc_hostmem_dealloc_r: ACC not compiled in.")
#endif
