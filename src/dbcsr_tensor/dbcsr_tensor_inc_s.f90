...
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_3d_block_s(tensor, ind, sizes, block)
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_4d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_5d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_6d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_anyd_block_s(tensor, ind, block)
      ...
      CASE(3)
         CALL dbcsr_t_put_3d_block_s(tensor, ind, block%sizes, block%blk)
      CASE(4)
         CALL dbcsr_t_put_4d_block_s(tensor, ind, block%sizes, block%blk)
      END SELECT
   END SUBROUTINE
...
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_3d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      REAL(kind=real_4), DIMENSION(sizes(1), sizes(2), sizes(3)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_4d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      REAL(kind=real_4), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_5d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                 :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)      :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)      :: sizes
      REAL(kind=real_4), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_6d_block_s(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      REAL(kind=real_4), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5), sizes(6)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_anyd_block_s(tensor, ind, block)
      ...
      SELECT CASE(dbcsr_t_ndims(tensor))
      CASE (3)
        CALL dbcsr_t_get_3d_block_s(tensor, ind, blk_size, block_arr)
      CASE (4)
        CALL dbcsr_t_get_4d_block_s(tensor, ind, blk_size, block_arr)
      END SELECT
