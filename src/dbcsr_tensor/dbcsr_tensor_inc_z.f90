...
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_3d_block_z(tensor, ind, sizes, block)
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_4d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_5d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5)), &
         INTENT(IN)                                               :: block
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_6d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5), sizes(6)), &
         INTENT(IN)                                               :: block
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsr_t_put_anyd_block_z(tensor, ind, block)
      TYPE(block_nd_z), INTENT(IN)                      :: block
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      ...
      CASE(3)
         CALL dbcsr_t_put_3d_block_z(tensor, ind, block%sizes, block%blk)
      CASE(4)
         CALL dbcsr_t_put_4d_block_z(tensor, ind, block%sizes, block%blk)
      END SELECT
   END SUBROUTINE
...
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_3d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3)), &
      ...
      COMPLEX(kind=real_8), DIMENSION(:,:), POINTER                            :: block_2d_ptr
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_4d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_5d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                 :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)      :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)      :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_6d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsr_t_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsr_t_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5), sizes(6)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsr_t_get_anyd_block_z(tensor, ind, block)
      ...
      SELECT CASE(dbcsr_t_ndims(tensor))
      CASE (3)
        CALL dbcsr_t_get_3d_block_z(tensor, ind, blk_size, block_arr)
      CASE (4)
        CALL dbcsr_t_get_4d_block_z(tensor, ind, blk_size, block_arr)
      END SELECT
