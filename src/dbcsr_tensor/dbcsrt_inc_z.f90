...
! **************************************************************************************************
   SUBROUTINE dbcsrt_put_3d_block_z(tensor, ind, sizes, block)
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsrt_put_4d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsrt_put_5d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: sizes
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsrt_put_6d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), &
         INTENT(IN)                                               :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: sizes
...
!> \param block block to put
! **************************************************************************************************
   SUBROUTINE dbcsrt_put_anyd_block_z(tensor, ind, block)
      ...
      CASE(3)
         CALL dbcsrt_put_3d_block_z(tensor, ind, block%sizes, block%blk)
      CASE(4)
         CALL dbcsrt_put_4d_block_z(tensor, ind, block%sizes, block%blk)
      END SELECT
   END SUBROUTINE
...
! **************************************************************************************************
   SUBROUTINE dbcsrt_get_3d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsrt_get_4d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsrt_get_5d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                 :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)      :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)      :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsrt_get_6d_block_z(tensor, ind, sizes, block)
      TYPE(dbcsrt_type), INTENT(INOUT)                            :: tensor
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: ind
      INTEGER, DIMENSION(dbcsrt_ndims(tensor)), INTENT(IN)        :: sizes
      COMPLEX(kind=real_8), DIMENSION(sizes(1), sizes(2), sizes(3), sizes(4), sizes(5), sizes(6)), &
...
!> \param block block to get
! **************************************************************************************************
   SUBROUTINE dbcsrt_get_anyd_block_z(tensor, ind, block)
      ...
      SELECT CASE(dbcsrt_ndims(tensor))
      CASE (3)
        CALL dbcsrt_get_3d_block_z(tensor, ind, blk_size, block_arr)
      CASE (4)
        CALL dbcsrt_get_4d_block_z(tensor, ind, blk_size, block_arr)
      END SELECT
