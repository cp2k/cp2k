...
!> \param trace ...
! **************************************************************************************************
  SUBROUTINE cp_dbcsr_trace_ab_c (matrix_a, matrix_b, trace)
...
!> \retval DATA ...
! **************************************************************************************************
  FUNCTION cp_dbcsr_get_wms_data_c (matrix, index_matrix, select_data_type, lb, ub) RESULT (DATA)
    TYPE(cp_dbcsr_type), INTENT(IN)  :: matrix
  ...
  END FUNCTION cp_dbcsr_get_wms_data_c
...
!> \retval DATA ...
! **************************************************************************************************
  FUNCTION cp_dbcsr_get_data_c (matrix, select_data_type, lb, ub) RESULT (DATA)
    TYPE(cp_dbcsr_type), INTENT(IN)  :: matrix
    COMPLEX(kind=real_4), INTENT(IN)              :: select_data_type
    COMPLEX(kind=real_4), DIMENSION(:), POINTER   :: DATA
    INTEGER, INTENT(IN), OPTIONAL    :: lb, ub
  ...
  END FUNCTION cp_dbcsr_get_data_c
...
!> \param work_col ...
! **************************************************************************************************
   SUBROUTINE cp_dbcsr_matrix_colvec_multiply_c(matrix, vec_in, vec_out, alpha, beta, work_row, work_col)
