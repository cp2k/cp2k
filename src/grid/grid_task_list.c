...
void grid_create_task_list(
    ...
    double **blocks_buffer, grid_task_list_t *task_list_ext) {
...
static void collocate_one_grid_level(
    const intl_task_list_t *task_list, const int first_task,
...
void grid_collocate_task_list(
    const grid_task_list_t task_list_ext, const bool orthorhombic,
