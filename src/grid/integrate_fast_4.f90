  ...
  SUBROUTINE integrate_core_0(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
  ...
  SUBROUTINE integrate_core_1(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_2(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_3(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_4(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_5(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_6(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_7(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_8(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
  ...
  SUBROUTINE integrate_core_9(grid,coef_xyz,pol_x,pol_y,pol_z,map,sphere_bounds,cmax,gridbounds,lp_maximum,cmax_maximum)
    USE kinds,                        ONLY: dp
    INTEGER, INTENT(IN)                      :: lp_maximum, cmax_maximum
    INTEGER, INTENT(IN)                      :: sphere_bounds(*), cmax, &
                                                map(-cmax:cmax,1:3), &
