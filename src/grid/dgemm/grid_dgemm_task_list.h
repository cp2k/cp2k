...
/*----------------------------------------------------------------------------*/
#ifndef GRID_DGEMM_TASK_LIST_H
#define GRID_DGEMM_TASK_LIST_H
 ...
 *        See grid_task_list.h for details.
 ******************************************************************************/
void grid_dgemm_collocate_task_list(grid_dgemm_task_list *const task_list,
                                    const enum grid_func func,
                                    const int nlevels,
                                    const offload_buffer *pab_blocks,
                                    offload_buffer *grids[nlevels]);

void grid_dgemm_integrate_task_list(void *const ptr, const bool compute_tau,
