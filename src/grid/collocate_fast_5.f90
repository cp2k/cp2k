...
! **************************************************************************************************
  SUBROUTINE collocate_core_1(grid, coef_xyz, pol_x, pol_y, pol_z, map, sphere_bounds, cmax, gridbounds)
     ...
     DO kg = kgmin, 0
        ...
        coef_xy(1, 1) = coef_xy(1, 1) + coef_xyz(4)*pol_z(1, 1, kg)
        coef_xy(2, 1) = coef_xy(2, 1) + coef_xyz(4)*pol_z(2, 1, kg)
        jgmin = sphere_bounds(sci)
        sci = sci + 1
        DO jg = jgmin, 0
           jg2 = 1 - jg
