...
! *****************************************************************************
  SUBROUTINE dbcsr_matrix_colvec_multiply_low_c(matrix, vec_in, vec_out, alpha, beta, work_row, work_col, error)
    ...
    CASE(dbcsr_type_symmetric)
       CALL dbcsr_matrixT_vector_mult_c(matrix, vec_in, vec_out, alpha, beta, work_row, work_col, .TRUE., error)
       CALL dbcsr_matrix_vector_mult_c(matrix, vec_in, vec_out, alpha, CMPLX(1.0, 0.0, real_4), work_row, work_col, error)
...
! Convert the result to a column wise distribution
    CALL dbcsr_rep_row_to_rep_col_vec_c(work_col, work_row, blk_map_row, error)
...
! Hope this clarifies the idea
  ...
  SUBROUTINE dbcsr_rep_row_to_rep_col_vec_c(rep_col_vec, rep_row_vec, blk_map_row, error)
