...
! *****************************************************************************
  SUBROUTINE Gram_Schmidt_ortho_z(h_vec, f_vec, s_vec, w_vec, nrow_local, j, local_history, local_comp, pcol_group)
...
! *****************************************************************************
  SUBROUTINE DGKS_ortho_z(h_vec, f_vec, s_vec, nrow_local, j, local_history, local_comp, pcol_group)
