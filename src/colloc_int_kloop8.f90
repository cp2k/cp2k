...
!
    ...
    DO ipoly=1,npoly
        p_v=0.0_dp
            ...
            p_v=p_v+poly_k(pShift+3)*k_vals(3)
            p_v=p_v+poly_k(pShift+4)*k_vals(4)
            p_v=p_v+poly_k(pShift+5)*k_vals(5)
            p_v=p_v+poly_k(pShift+6)*k_vals(6)
            p_v=p_v+poly_k(pShift+7)*k_vals(7)
            p_v=p_v+poly_k(pShift+8)*k_vals(8)
