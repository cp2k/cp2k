...
| `WAVELET`   | 0D, 2D, 3D                    | Requires FFTSG-compatible grid dimensions; keep [EXTENDED_FFT_LENGTHS](#CP2K_INPUT.GLOBAL.EXTENDED_FFT_LENGTHS) at its default value, `.FALSE.`. The density must decay to zero at nonperiodic cell faces. [](#Genovese2006) [](#Genovese2007) |
