...
extern "C" void
gpu_d_gemm_ (char &transa, char &transb, int &m, int &n, int &k,
	     ...
	     double &beta, double *c, int &ldc)
{
  ...
  cublasDgemm (transa, transb, m, n, k, alpha, ptra, la, ptrb, lb, beta, ptrc,
	       m);
...
extern "C" void
gpu_d_symm_ (char &side, char &uplo, int &m, int &n, double &alpha, double *a,
