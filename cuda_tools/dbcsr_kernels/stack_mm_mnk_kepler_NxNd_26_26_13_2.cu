// DBCSR_KERNEL datatype=dbcsr_type_real_8, homogeneous_only=True, m=26, n=26, k=13
#include "dbcsr_kernel.h"
#include "dbcsr_generic_kernel.h"

int
launch_stack_mm_mnk_kepler_NxNd_26_26_13_2 (int *param_stack, int stack_size,
					    ...
					    double *c_data)
{
  ...
  stack_mm_mnk_kepler_NxNd < 26, 26, 13,
