// DBCSR_KERNEL datatype=dbcsr_type_real_8, homogeneous_only=True, m=8, n=23, k=5
#include "dbcsr_kernel.h"
#include "dbcsr_generic_kernel.h"

int
launch_stack_mm_mnk_kepler_NxNd_8_23_5_2 (int *param_stack, int stack_size,
					  ...
					  double *c_data)
{
  ...
  stack_mm_mnk_kepler_NxNd < 8, 23, 5,
