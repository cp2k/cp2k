// DBCSR_KERNEL datatype=dbcsr_type_real_8, homogeneous_only=True, m=16, n=16, k=23
#include "dbcsr_kernel.h"
#include "dbcsr_generic_kernel.h"

int
launch_stack_mm_mnk_kepler_NxNd_16_16_23_2 (int *param_stack, int stack_size,
					    ...
					    double *c_data)
{
  ...
  stack_mm_mnk_kepler_NxNd < 16, 16, 23,
