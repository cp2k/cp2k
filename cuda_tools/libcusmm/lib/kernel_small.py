...
class SmallKernel(object):
    def __init__(self, **params):
        self.__dict__.update(params)
        self.name  = "cusmm_kernel_small_"
    ...
    def launcher_code(self):
       ...
       output += "cusmm_kernel_small<%(m)d,%(n)d,%(k)d,%(tile_m)d,%(tile_n)d,%(grouping)d> "%self.__dict__
