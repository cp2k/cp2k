...
ENV SPACK_PACKAGES_VERSION=${{SPACK_PACKAGES_VERSION:-ec6c0f3435d3a862337a7af71d07790f4d116274}}
...
RUN mkdir -p $SPACK_ROOT \
    ...
    && tar -xzvf $SPACK_VERSION.tar.gz -C /opt && rm -f $SPACK_VERSION.tar.gz \
    && mkdir -p $SPACK_PACKAGES_ROOT \
    && curl -OL $SPACK_PACKAGES_REPO/archive/$SPACK_PACKAGES_VERSION.tar.gz \
    && tar -xzvf $SPACK_PACKAGES_VERSION.tar.gz -C /opt && rm -f $SPACK_PACKAGES_VERSION.tar.gz
