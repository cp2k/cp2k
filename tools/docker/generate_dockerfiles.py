...
RUN git init --quiet && \
    ...
    git fetch --quiet --depth 1 origin develop-2023-12-17 && \
...
RUN spack mirror add develop-2023-12-17 https://binaries.spack.io/develop-2023-12-17 && spack buildcache keys --install --trust
