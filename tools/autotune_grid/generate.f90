...
write(iunit,'(A)')""
write(iunit,'(A)')"#if defined(__SGL)"
write(iunit,'(A)')"  INTEGER, PARAMETER :: wp = KIND(0.0)"
write(iunit,'(A)')"#else"
write(iunit,'(A)')"  INTEGER, PARAMETER :: wp = SELECTED_REAL_KIND ( 14, 200 )"
write(iunit,'(A)')"#endif"
...
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: pol_x(0:lp,-cmax:cmax)"
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: pol_y(1:2,0:lp,-cmax:0)"
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: pol_z(1:2,0:lp,-cmax:0)"
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: coef_xyz(((lp+1)*(lp+2)*(lp+3))/6)"
write(iunit,'(A)')"    real(wp), INTENT(INOUT) :: grid(gridbounds(1,1):gridbounds(2,1), & "
...
write(iunit,'(A)')"                                    gridbounds(1,3):gridbounds(2,3))"
write(iunit,'(A)')""
write(iunit,'(A)')"    real(wp) ::  coef_xy(2,(lp+1)*(lp+2)/2)"
write(iunit,'(A)')"    real(wp) ::  coef_x(4,0:lp)"
write(iunit,'(A)')""
write(iunit,'(A)')"    integer kg,k,jgmin,jg,j,j2,igmax,ig,i,kgmin,igmin,k2,i2,jg2,kg2"
write(iunit,'(A)')"    integer sci,lxp,lyp,lzp"
write(iunit,'(A)')"    real(wp) s01,s02,s03,s04,s(4)"
...
SUBROUTINE write_ig_loop()
  ...
  CASE(0)
     write(iunit,'(A)')"             s01=0.0_wp"
     write(iunit,'(A)')"             s02=0.0_wp"
     write(iunit,'(A)')"             s03=0.0_wp"
     write(iunit,'(A)')"             s04=0.0_wp"
  CASE(1)
     write(iunit,'(A)')"             s(:)=0.0_wp"
  END SELECT
...
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: pol_y(1:2,0:lp,-cmax:0)"
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: pol_z(1:2,0:lp,-cmax:0)"
write(iunit,'(A)')"    real(wp), INTENT(OUT)   :: coef_xyz(((lp+1)*(lp+2)*(lp+3))/6)"
write(iunit,'(A)')"    real(wp), INTENT(IN)    :: grid(gridbounds(1,1):gridbounds(2,1), & "
write(iunit,'(A)')"                                    gridbounds(1,2):gridbounds(2,2), &"
write(iunit,'(A)')"                                    gridbounds(1,3):gridbounds(2,3))"
