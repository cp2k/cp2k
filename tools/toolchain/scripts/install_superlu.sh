...
export CP_CFLAGS="\${CP_CFLAGS} IF_MPI(IF_OMP(${SUPERLU_CFLAGS}|)|)"
export CP_LDFLAGS="\${CP_LDFLAGS} IF_MPI(IF_OMP(${SUPERLU_LDFLAGS}|)|)"
export CP_LIBS="IF_MPI(IF_OMP(${SUPERLU_LIBS}|)|) \${CP_LIBS}"
EOF
fi
