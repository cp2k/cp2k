...
foreach(_lib ptscotchparmetis ptscotch ptscotcherr scotchmetis scotch scotcherr ptesmumps)
  string(TOUPPER "${_lib}" _lib_up)
  cp2k_find_libraries("${_lib_up}" ${_lib})
endforeach()

#search for include files
cp2k_include_dirs(PTSCOTCH "ptscotch.h openmpi/include/ptscotch.h ptsctoch/ptscotch.h")
...
if (CP2K_PTSCOTCH_FOUND AND NOT TARGET CP2K_ptscotch::ptscotch)
  ...
  set_target_properties(
    ...
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PTSCOTCH_INCLUDE_DIRS}"
    INTERFACE_LINK_LIBRARIES "${CP2K_PTSCOTCH_LINK_LIBRARIES};
  ${CP2K_PTSCOTCHPARMETIS_LINK_LIBRARIES};
  ${CP2K_PTSCOTCHERR_LINK_LIBRARIES};
  ${CP2K_SCOTCHMETIS_LINK_LIBRARIES};
  ${CP2K_SCOTCH_LINK_LIBRARIES};
