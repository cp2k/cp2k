...
if(CP2K_TBLITE_INCLUDE_DIRS)
  find_package_handle_standard_args(tblite DEFAULT_MSG CP2K_TBLITE_INCLUDE_DIRS
...
if(CP2K_TBLITE_FOUND)
  ...
  set_target_properties(
    cp2k::tblite::tblite
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${CP2K_TBLITE_INCLUDE_DIRS}"
               INTERFACE_LINK_LIBRARIES "${CP2K_TBLITE_LINK_LIBRARIES}")
endif()

mark_as_advanced(CP2K_TBLITE_LINK_LIBRARIES CP2K_TBLITE_INCLUDE_DIRS
                 CP2K_TBLITE_FOUND)
